...
public class JDBCTemplate {
	...
	//2.전달받은 JDBC용 객체를 반납시켜주는 메소드(각 객체별로 따로만든다)
	...
	//2_2)Statement 객체 반납 메소드 (PreparedStatement객체가 Statement객체의 자식이기때문에 다형성이 적용되어 매개변수로 전달 가능)
	...
	//3. 전달받은 Connection객체를 이용해서 트랜잭션 처리를 해주는 메소드
